...
namespace Simple.Abp.Test.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220114015526_Init-AuditLoging")]
    partial class InitAuditLoging
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simple.Abp.Articles.Article", b =>
                {
                    ...
                    b.ToTable("AbpArticles", (string)null);
                });

            modelBuilder.Entity("Simple.Abp.Articles.ArticleCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AbpArticleCatalogs", (string)null);
                });

            modelBuilder.Entity("Simple.Abp.Articles.ArticleTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AbpArticleTags", (string)null);
                });
            ...
            modelBuilder.Entity("Simple.Abp.Articles.Article", b =>
                {
                    b.HasOne("Simple.Abp.Articles.ArticleCatalog", "Catalog")
                        .WithMany()
